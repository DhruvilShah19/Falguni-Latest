  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 bg-[var(--color-bg)]">
      ...
      <div className="w-full max-w-sm bg-[var(--color-card)] border border-[var(--color-border)] rounded-3xl p-6 shadow-sm">
        <h1 className="text-xl font-bold text-[var(--color-fg)] mb-1">Welcome back</h1>
        <p className="text-sm text-[var(--color-fg-muted)] mb-6">Sign in to your account</p>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="text-right mt-1">
              <Link href="/forgot-password" className="text-xs text-[var(--color-gold)] hover:underline">Forgot password?</Link>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-[var(--color-fg-muted)] mt-5">
          ...
          <Link href="/signup" className="text-[var(--color-gold)] font-semibold hover:underline">Sign Up</Link>
        </p>
      </div>
    </div>
  );
