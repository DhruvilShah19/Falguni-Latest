...
class FlashSalesSlidesHome extends StatefulWidget {
  const FlashSalesSlidesHome({
    super.key,
  });

  @override
  State<FlashSalesSlidesHome> createState() => _FlashSalesSlidesHomeState();
}

class _FlashSalesSlidesHomeState extends State<FlashSalesSlidesHome> {
