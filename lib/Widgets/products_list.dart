...
class ProductList extends StatefulWidget {
  ...
  const ProductList(
      {super.key, required this.marketID, required this.collection});
...
class _ProductListState extends State<ProductList> {
  ...
  Future<List<ProductsModel>> getAllMyProducts() {
    return FirebaseFirestore.instance
        .collection('Products')
        .where('marketID', isEqualTo: widget.marketID)
        .get()
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ProductsModel>>(
        future:
            widget.collection == 'All' ? getAllMyProducts() : getMyProducts(),
                                                  ...
                                                  if (userRef == null) {
                                                    ...
                                                    addToCart(ProductsModel(
                                                        ...
                                                        unitPrice1: productModel
                                                            .unitPrice1,
                                                        unitPrice2: productModel.unitPrice2,
